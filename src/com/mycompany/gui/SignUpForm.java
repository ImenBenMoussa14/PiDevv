...
public class SignUpForm extends BaseForm {
  ...
  //      role = new ComboBox<>(VectorRole);
        ...
        next.addActionListener((register) -> {
                String url = "http://localhost/ProjetWebSymfony/test/web/app_dev.php/api/register?username="+username.getText().toString()+"&password="+password.getText().toString()+"&email="+emaill.getText().toString()+"&roles="+role.getSelectedItem().toString();
