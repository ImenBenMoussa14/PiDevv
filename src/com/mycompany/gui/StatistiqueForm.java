...
public class StatistiqueForm extends BaseForm {
        ...
        double li = (double)es.getNbrReclamation();
        
           ServiceFeedback fs = new ServiceFeedback();
        double feedback  = (double)fs.getNbrFeedback();
...
BaseForm form;
        ...
        addTab(swipe, res.getImage("feedback.jpg"), spacer1, "Bienvenue a service aprés vente");
...
//        for (double value : values) {           
            series.add("Reclamation " , valuesRec);
            series.add("Feedback" , valuesFeed);
//        }
        return series;
    }
